...
figure(1); title('インパルス応答','FontName','MS Gothic','FontSize',15)
figure(2); title('単位ステップ応答','FontName','MS Gothic','FontSize',15)
figure(3); title('単位ランプ応答','FontName','MS Gothic','FontSize',15)
